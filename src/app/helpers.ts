...
const
  ...
  RL_CREDIT_TEXT = 'Created By Yesticket',
...
const createFurniture = (type: string, object, chair = {}, seat?: any ) => {
  if (type === 'TABLE') {
    ...
    let newParts = [];
    if (seat) {
      stroke = seat.pricecategory_color;
    ...
    return createShape({...object, parts: [...object.parts, ...newParts]}, stroke, fill, type);
  }
};

/** Adding Chairs */
const createShape = (object: any, stroke, fill, type: string = 'CHAIR'): fabric.Group => {
