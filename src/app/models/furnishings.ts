  ...
  'miscellaneous': [
    {
      ...
      'flexible': true,
      'parts': [
        { 'type': 'rect', 'definition': { left: 0, top: 0, width: 36, height: 36, strokeUniform: true} }
      ]
    },
    {
      'title': 'Circle',
      ...
      'flexible': true,
      'parts': [
        { 'type': 'circle', 'definition': {  originX: 'center', originY: 'center', radius: 18,  strokeUniform: true } }
      ]
    },
    // {
